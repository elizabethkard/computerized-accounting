...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <h1 class="text-center mb-2 mt-3 ">Detail Posting</h1>
...
<?php
    include "config.php";
    $sql = "SELECT * FROM transaksi INNER JOIN detail_transaksi ON transaksi.kode_transaksi = detail_transaksi.kode_transaksi WHERE posting=0 AND deleted=0 ORDER BY id DESC";
    ...
    while($row = $result->fetch_assoc()): ?>
          <tbody>
            <tr>
                ...
                <td><?php echo $row['tgl transaksi'];?></td>
                ...
                <a href="serverposting.php?id=<?php echo $row['no_transaksi']; ?>" class="btn btn-outline-danger" onclick="return confirm('Apakah anda sudah yakin ?')"><i class="fas fa-trash-alt "></i></a></td>
            </tr>    
          </tbody>
          <?php  endwhile; ?>
      </table>
